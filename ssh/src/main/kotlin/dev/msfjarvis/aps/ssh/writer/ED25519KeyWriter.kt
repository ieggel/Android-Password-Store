...
class ED25519KeyWriter(private val context: Context, private val requiresAuthentication: Boolean): SSHKeyWriter {

  override suspend fun writePrivateKey(privateKey: PrivateKey, privateKeyFile: File) = withContext(Dispatchers.IO) {
    val encryptedPrivateKeyFile = getOrCreateWrappedPrivateKeyFile(requiresAuthentication, privateKeyFile)
  ...
  private suspend fun getOrCreateWrappedPrivateKeyFile(requiresAuthentication: Boolean, privateKeyFile: File) = withContext(Dispatchers.IO) {
